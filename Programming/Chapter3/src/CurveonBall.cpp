...
int main() {
    ...
    for (int numPoints : numPointsArray) {
        ...
        try {
            ...
            std::string dataFileName = "spline_ball_data_" + std::to_string(numPoints) + ".txt";
            std::string gnuplotScriptName = "plot_ball_" + std::to_string(numPoints) + ".gp";
            std::string outputImageName = "B" + std::to_string(1) + "r3spline_ball_" + std::to_string(numPoints) + ".png";
            ...
            gnuplotScript << "splot '" << dataFileName << "' with lines title 'r_3 (" << numPoints << " points), BType" << 1 << "'\n";
            gnuplotScript.close();
